...
// /**
//  * Cas 1 : Recherche seul
//  *
//  * Cas 2 : Click sur 1 tag ``
//  * Cas 3 : Recherche global + click tag
//  * Cas 4 : click Tag ensuite recherche
//  *
//  * Dés qu'il y a recherche ou click,
//  *
//  * function globalFilter (data){
//  * recipes =  handleSearch(data) //filterData
//  * recipes = filterByIngredientTags(recipes)
//  * recipes = filterByUstensilTags(recipes)
//  * recipes = filterByApplianceTags(recipes)
//  *
//  * return recipes
//  *
//  * }
...
//  * 
//  *  buildCards(recipes) // createListCard
//  *  
//  * 
//  * buildIngredientList  buildApplianceList  buildUstensilList ---> 
...
// tagsButtons.on("click")
    
//  */

// /**
//  * Filter les cartes par rapport à la barre de recherche
//  * @param {*} e
//  */
...
//       el.ingredients[0].ingredient.toLowerCase().includes()
//     );
//   }
...
// /**
//  * Création de la liste d'ingrédient
//  * @param {*} ingredients
//  * @param {*} canAddToIngredients
//  */
...
//     console.log("ici le filter ingredient", arrayIngredientFilter);
...
//   console.log("ingredient", filterIngredients);
// }
